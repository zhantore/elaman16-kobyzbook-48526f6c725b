...
public class MusicChooserActivity extends ActionBarActivity {
    ...
    private static final String TAG = "MusicChooserActivity";
    ...
    private void loadAllSongs() {
        ...
        mPhoneMediaControl.loadMusicList(context, -1, PhoneMediaControl.SonLoadFor.AllSongs,"");
    }
    ...
    public class AllSongsListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            Log.d(TAG, "AllSongsListAdapter->getView()");
