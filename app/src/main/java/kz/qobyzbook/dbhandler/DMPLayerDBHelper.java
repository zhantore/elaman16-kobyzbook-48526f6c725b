 ...
 */
package kz.qobyzbook.dbhandler;
...
public class DMPLayerDBHelper extends SQLiteOpenHelper {
    ...
    public DMPLayerDBHelper(Context context) {
        super(context, context.getResources().getString(kz.qobyzbook.R.string.DataBaseName), null, Integer.parseInt(context.getResources().getString(kz.qobyzbook.R.string.DataBaseName_Version)));
        this.context_ = context;
        DATABASE_NAME = context.getResources().getString(kz.qobyzbook.R.string.DataBaseName);
        DATABASE_VERSION = Integer.parseInt(context.getResources().getString(kz.qobyzbook.R.string.DataBaseName_Version));
