...
public class Slider extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        setBackgroundResource(kz.qobyzbook.R.drawable.background_transparent);
    ...
    class Ball extends View {
        ...
        public void changeBackground() {
            setBackgroundResource(kz.qobyzbook.R.drawable.background_checkbox);
            LayerDrawable layer = (LayerDrawable) getBackground();
            GradientDrawable shape = (GradientDrawable) layer.findDrawableByLayerId(kz.qobyzbook.R.id.shape_bacground);
