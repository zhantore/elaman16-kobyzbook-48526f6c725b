...
public class PlayPauseView extends FrameLayout {
    ...
    public PlayPauseView(Context context, AttributeSet attrs) {
        ...
        context.getTheme().resolveAttribute(kz.qobyzbook.R.attr.colorAccent, colorTheme, true);
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, kz.qobyzbook.R.styleable.PlayPause);
        isDrawCircle = a.getBoolean(kz.qobyzbook.R.styleable.PlayPause_isCircleDraw, isDrawCircle);
    }
