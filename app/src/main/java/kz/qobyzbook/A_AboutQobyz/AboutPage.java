...
public class AboutPage extends AppCompatActivity implements View.OnClickListener, Slider.OnValueChangedListener,
...
//        mToolbarView.setBackgroundColor(ScrollUtils.getColorWithAlpha(0, color));
            ...
            public void onClick(View v) {
                if (v.getId()==R.id.btn_update){
                    if (isOnline())
                        ...
                        Toast.makeText(getBaseContext() ,getResources().getString(R.string.no_internet),Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    void makeJsonStringRequest(){
        Log.d(TAG, "makeJsonStringRequest()");
        ...
        JsonObjectRequest aboutQobyzReq = new JsonObjectRequest(URL,
