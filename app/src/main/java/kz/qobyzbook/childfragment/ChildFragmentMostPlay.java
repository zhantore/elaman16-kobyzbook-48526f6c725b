...
public class ChildFragmentMostPlay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(kz.qobyzbook.R.layout.fragmentchild_mostplay, null);
    ...
    private void setupInitialViews(View inflatreView) {
        recycler_songslist = (ListView) inflatreView.findViewById(kz.qobyzbook.R.id.recycler_allSongs);
