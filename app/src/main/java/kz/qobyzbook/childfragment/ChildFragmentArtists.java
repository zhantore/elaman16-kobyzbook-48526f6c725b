 ...
 */
package kz.qobyzbook.childfragment;
...
import kz.qobyzbook.adapter.CursorRecyclerViewAdapter;
import kz.qobyzbook.utility.LogWriter;
import kz.qobyzbook.phonemidea.DMPlayerUtility;
import kz.qobyzbook.phonemidea.MusicAlphabetIndexer;
...
public class ChildFragmentArtists extends Fragment {
    ...
    public class ArtistsRecyclerAdapter extends CursorRecyclerViewAdapter<ArtistsRecyclerAdapter.ViewHolder> {
        ...
        protected ArtistsRecyclerAdapter(Context context, Cursor cursor) {
            ...
            mDefaultAlbumIcon = (BitmapDrawable) r.getDrawable(kz.qobyzbook.R.drawable.bg_default_album_art);
            ...
            mUnknownArtist = context.getString(kz.qobyzbook.R.string.unknown_artist_name);
        }
        ...
        private void getColumnIndices(Cursor cursor) {
            if (cursor != null) {
                ...
                if (mIndexer != null) {
                    ...
                    mIndexer = new MusicAlphabetIndexer(cursor, mGroupArtistIdx, mResources.getString(kz.qobyzbook.R.string.fast_scroll_alphabet));
                }
            }
        }
        ...
        protected class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public ViewHolder(View itemView) {
                super(itemView);
                line1 = (TextView) itemView.findViewById(kz.qobyzbook.R.id.line1);
                line2 = (TextView) itemView.findViewById(kz.qobyzbook.R.id.line2);
            ...
            public void onClick(View view) {
                try {
                    ...
                    mBundle.putLong("tagfor", PhoneMediaControl.SonLoadFor.LessonAudio.ordinal());
                    mBundle.putString("albumname", ((TextView) view.findViewById(kz.qobyzbook.R.id.line1)).getText().toString().trim());
                    mBundle.putString("title_one", "AllSongs my songs");
                    mBundle.putString("title_sec", ((TextView) view.findViewById(kz.qobyzbook.R.id.line2)).getText().toString().trim());
