 ...
 */
package kz.qobyzbook.recyclerviewutils;
...
public class ItemSelectionSupport {
    ...
    public static ItemSelectionSupport addTo(RecyclerView recyclerView) {
        ...
        if (itemSelectionSupport == null) {
            ...
            recyclerView.setTag(kz.qobyzbook.R.id.recyclerview_item_selection_support, itemSelectionSupport);
        } else {
            // TODO: Log warning
        }
    ...
    public static void removeFrom(RecyclerView recyclerView) {
        ...
        recyclerView.setTag(kz.qobyzbook.R.id.recyclerview_item_selection_support, null);
    }
    ...
    public static ItemSelectionSupport from(RecyclerView recyclerView) {
        ...
        return (ItemSelectionSupport) recyclerView.getTag(kz.qobyzbook.R.id.recyclerview_item_selection_support);
    }
