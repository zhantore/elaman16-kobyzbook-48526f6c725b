...
public class LessonNote extends AppCompatActivity implements View.OnClickListener, Slider.OnValueChangedListener,
    ...
    //Constants
    String URL = "http://admin.kobyzbook.kz/";
    int id = 0;
    private String name = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = LessonNote.this;
        theme();
        //Set your Layout view
        super.onCreate(savedInstanceState);
        setContentView(R.layout.c_lesson_note);
            ...
            public void onClick(View v) {
                if (v.getId()==R.id.btn_update){
                    if (isOnline())
                        ...
                        Toast.makeText(getBaseContext() ,getResources().getString(R.string.no_connect),Toast.LENGTH_SHORT).show();
                }
            }
        });

        imageNote = (ImageView) findViewById(R.id.imageView);
    ...
    void makePicassoRequest(){

        Uri uri = Uri.parse(description);
        Picasso.with(context)
                .load(uri)
                .into(imageNote, new com.squareup.picasso.Callback() {
                    @Override
