                ...
                switch (which){
                    case 0:
                        try {
                            ...
                            mBundle.putString(TITLE_LESSON,getResources().getStringArray(R.array.lessons_array_kz)[which]);
                    ...
                    case 1:
                        ...
                        intent.putExtra("title",getResources().getStringArray(R.array.lessons_array_kz)[which]);
                    ...
                    switch (which){
                        case 0:
                            try {
                                Intent mIntent = new Intent(getActivity(), PersonPage.class);
                                Bundle mBundle = new Bundle();
                                mBundle.putString(TITLE_LESSON,getResources().getStringArray(R.array.lessons_array_en)[which]);
                                mBundle.putString(DESCRIPTION_LESSON, LessonAdapter.List.get(LessonAdapter.pos).getMif());
                                mIntent.putExtras(mBundle);
                                getActivity().startActivity(mIntent);
                                getActivity().overridePendingTransition(0, 0);
                        ...
                        case 1:
                            Intent intent = new Intent(getActivity(), VideoPage.class);
                            intent.putExtra("title",getResources().getStringArray(R.array.lessons_array_en)[which]);
                            intent.putExtra("youtubeId",LessonAdapter.List.get(LessonAdapter.pos).getVideo());
                            getActivity().startActivity(intent);
                            break;
                        case 2:
