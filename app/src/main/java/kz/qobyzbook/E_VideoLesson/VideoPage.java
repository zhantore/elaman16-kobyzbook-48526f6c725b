...
public class VideoPage extends AppCompatActivity implements View.OnClickListener, Slider.OnValueChangedListener,
    ...
    public static final String DEVELOPER_KEY = "AIzaSyBALiZiVwsJ_YsRKtR3j2JrhmdAup1gIi0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = VideoPage.this;
        theme();
        //Set your Layout view
        super.onCreate(savedInstanceState);
        setContentView(R.layout.e_video_page);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player,
        ...
        String yourTransferredData = intent.getExtras().getString("youtubeId");
        Log.d("Intent",yourTransferredData);
        if (!wasRestored) {
            player.cueVideo(yourTransferredData);
        }
    }
    @Override
